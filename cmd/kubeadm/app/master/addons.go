...
func createKubeDNSPodSpec(s *kubeadmapi.MasterConfiguration) api.PodSpec {
	...
	return api.PodSpec{
		...
		Containers: []api.Container{
			...
			{
				Name:  "kube-dns",
				Image: images.GetAddonImage(s, images.KubeDNSImage),
			...
			{
				Name:  "dnsmasq",
				Image: images.GetAddonImage(s, images.KubeDNSmasqImage),
				Resources: api.ResourceRequirements{
					Limits:   dnsPodResources,
					Requests: dnsPodResources,
				},
			...
			{
				Name:  "healthz",
				Image: images.GetAddonImage(s, images.KubeExechealthzImage),
				Resources: api.ResourceRequirements{
